	...
	<div class="form1">
		...
		<div class="form_container">
			<!--form action="index.php" method="post" class="form_item">
				...
				<label><br> Course </label><input type="text" name="c1"><br>
				<label><br> Year Level </label><input type="text" name="yr"><br>
			...
			if(isset($_POST["sbtn"])){
				include("config.php");
				$inser2="insert into permit_tb(sem1,ay1,fname,course1,yearlevel1,school1,grant1) values('".$_POST['sem']."','".$_POST['ay']."','".$_POST['fn']."','".$_POST['c1']."','".$_POST['yr']."','".$_POST['schl']."','".$_POST['gra1']."')";
			  ...
			  while($row2=mysqli_fetch_array($qr2)){
				 ...
				 <tr>
					 <form action="index.php" method="post">
						...
						<td class="td_buttons">
							  <input type="hidden" value="<?php echo $row2['id']; ?>" name="delt3">
							  <input style="font-family:Times New Roman; background-color: rgb(89, 4, 4); color:white; width:150px;" type="submit" value="Delete" name="delbtn" >  
							  <input style="font-family:Times New Roman; background-color: rgb(89, 4, 4); color:white; width:150px;" type="submit" value="Update" name="upbtn">
						</td>
					</form>
				 </tr>
			<?php 
